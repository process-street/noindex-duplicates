jQuery(document).ready(function($){
	...
	$('[id^="duplicate_entry_apply_"]').click(function(){
		...
		var duplicateEntryItemsTonoindex = {};
		duplicateEntryItemsTonoindex[thisEntry] = $('#duplicate_entry_items_to_noindex_'+thisEntry).val();
		...
		var data = {
			...
			duplicate_entry_items_to_noindex: duplicateEntryItemsTonoindex
		}
	...
	// warn people doing the bulk noindex
	$('#duplicate_entry_noindex_all').click(function(){
		$('#duplicate_entry_warning').show();
		$('#duplicate_entry_redirect_all').attr('disabled','disabled');
	});
	$('#duplicate_entry_noindex_below').click(function(){
